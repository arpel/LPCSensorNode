...
/** @defgroup BOARD_NXP_XPRESSO_812 NXP LPC812 LPCXpresso board support software API functions
 * @ingroup LPCOPEN_8XX_BOARD_XPRESSO_812
...
/** @defgroup BOARD_NXP_XPRESSO_812_OPTIONS BOARD: LPC812 LPCXpresso board build options
